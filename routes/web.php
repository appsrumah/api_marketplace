...
/* ═════════════════════════════════════════════════════════════════════════
 | WEBHOOK — Publik, menerima event dari TikTok (tanpa sesi login)
 | TikTok mengirim POST ke URL ini saat ada event (order, chat, dll)
 ═════════════════════════════════════════════════════════════════════════ */
Route::post('/webhooks/tiktok', [TiktokWebhookController::class, 'receive'])
    ->name('webhooks.tiktok.receive');
...
Route::middleware(['auth', 'check.active'])->group(function () {
    ...
    Route::prefix('webhooks/tiktok')->name('webhooks.tiktok.')->group(function () {
        Route::get('/events',                [TiktokWebhookController::class, 'events'])->name('events');
        Route::post('/events/{event}/retry', [TiktokWebhookController::class, 'retry'])->name('retry');
        Route::post('/register/{account}',   [TiktokWebhookController::class, 'register'])->name('register');
        Route::get('/registered/{account}',  [TiktokWebhookController::class, 'registered'])->name('registered');
    });
