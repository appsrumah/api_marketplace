...
$results = [];
$nextBatch = function () { return DB::table('migrations')->max('batch') + 1; };
...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', monospace; background: #0f172a; color: #e2e8f0; padding: 20px; max-width: 900px; margin: 0 auto; }
        ...
        .err { color: #f87171; padding: 4px 0; }
        .inf { color: #94a3b8; padding: 4px 0; }
        table { border-collapse: collapse; margin-top: 12px; width: 100%; }
        td, th { border: 1px solid #334155; padding: 8px 14px; }
        th { background: #1e293b; color: #38bdf8; font-weight: 600; }
        tr:hover { background: #1e293b; }
        .warn { background: #422006; color: #fbbf24; padding: 12px 16px; border-left: 4px solid #f59e0b; margin: 16px 0; border-radius: 6px; }
